# Resource to create aws acm certificate.
resource "aws_acm_certificate" "expense" {
  domain_name       = "*.expense.rskrishnacloudtech.online"
...
# Resource to create a R53 record for expense for https.
...
# Resource to create the certificate validation.
